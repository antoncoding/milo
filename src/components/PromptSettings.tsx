  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-8">
      ...
      <div className="bg-white p-6 rounded-lg border border-slate-200">
        ...
        {!isFormOpen && (
          <button 
            className="flex items-center justify-center gap-2 w-full p-3 border-2 border-dashed border-slate-200 rounded-lg bg-transparent text-slate-600 cursor-pointer transition-all duration-200 hover:border-slate-300 hover:text-slate-700 mt-4"
