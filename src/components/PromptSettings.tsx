    ...
    <div className="settings-container">
      <div className="section-header">
        ...
        <p className="header-description">
          Create and manage custom prompts to transform your text in different styles. 
          Select a prompt as your default tone or create new ones for different purposes.
        </p>
      </div>
